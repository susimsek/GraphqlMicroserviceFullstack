...
@Component
internal class DataInitializr(private val reviewRepository: ReviewRepository) : CommandLineRunner {
    ...
    override fun run(args: Array<String>) {
        reviewRepository
            ...
            .thenMany<Any>(
                Flux
                    .just(Review(id = "1020", productId = "1", text = "Very cramped :( Do not recommend.", starRating = 2),
